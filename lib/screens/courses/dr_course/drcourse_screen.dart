...
import 'package:prexam/screens/courses/dr_course/drcourse_list.dart';
// import the next screen if you have one
// import 'package:prexam/screens/tasks/doctor/doctorlist.dart';

class DoctorCourseScreen extends StatelessWidget {
  const DoctorCourseScreen({super.key});
    ...
    return Scaffold(
      ...
      body: ListView.separated(
        ...
        itemBuilder: (context, index) {
          final course = doctorCourses[index];

          return InkWell(
            borderRadius: BorderRadius.circular(12),
            onTap: () {
              // 🔁 Navigate to next screen if needed
              Get.to(() => DoctorListScreen(subjectTitle: course['title']));
